if (!textMode) {
	...
	draw_line_width(-5,window_get_height()*.75,window_get_width() - 250,window_get_height()*.75,10)
	draw_line_width(-5,window_get_height()*.7,window_get_width() - 300,window_get_height()*.7,5)
